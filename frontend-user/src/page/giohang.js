...
function GioHang(){
    ...
    async function kiemTraThanhToan(){
        ...
        var toDistrictId = selectDiaChi.districtId
        var toWardCode = selectDiaChi.wardCode
                    ...
                    <div class="col-sm-4">
                        ...
                        <div>
                            <Select
                                ...
                                getOptionLabel={(option) => option.tenDuong+", "+option.xaPhuong+", "+option.quanHuyen+", "+option.tinhThanhPho} 
